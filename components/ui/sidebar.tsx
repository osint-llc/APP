...
const sidebarItemStyles = tv({
  ...
  variants: {
    ...
    isCurrent: {
      true: "bg-primary/10 font-medium text-primary data-hovered:bg-primary/20 data-hovered:text-primary **:data-[slot=menu-trigger]:from-primary/5 **:data-[slot=icon]:text-primary [&_.text-muted-fg]:text-primary-fg/80",
    },
    isActive: {
